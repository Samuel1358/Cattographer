...
public class HUD_PosicoesResponsivas : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        /*timer.anchorMin = new Vector2(0f, 1f);
        timer.anchorMax = new Vector2(0f, 1f);
        timer.pivot = new Vector2(0.5f, 0.5f);*/
        ...
        /*verdes.anchorMin = new Vector2(1f, 1f);
        verdes.anchorMax = new Vector2(1f, 1f);
        verdes.pivot = new Vector2(0.5f, 0.5f);*/
        ...
        /*amarelos.anchorMin = new Vector2(1f, 1f);
        amarelos.anchorMax = new Vector2(1f, 1f);
        amarelos.pivot = new Vector2(0.5f, 0.5f);*/
